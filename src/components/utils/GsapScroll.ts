...
interface ScreenObject extends THREE.Object3D {
...
export function setCharTimeline(
  ...
  let screenLight: ScreenObject | undefined, monitor: ScreenObject | undefined;
  character?.children.forEach((object: THREE.Object3D) => {
    if (object.name === "Plane004") {
      object.children.forEach((child: THREE.Object3D) => {
        const material = (child as ScreenObject).material;
        material.transparent = true;
        material.opacity = 0;
        if (material.name === "Material.027") {
          monitor = child as ScreenObject;
    ...
    if (object.name === "screenlight") {
      ...
      screenLight = object as ScreenObject;
    }
  });
